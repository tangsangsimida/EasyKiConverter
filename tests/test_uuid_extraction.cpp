...
int main(int argc, char* argv[]) {
    ...
    QString test1 =
        "SVGNODE~{\"attrs\":{\"uuid\":\"adad5b22370b40e298ad6709efc97dab\",\"title\":\"RELAY-TH_8358-012-1HP\",\"c_"
        "etype\":\"outline3D\",\"layerid\":19}}";
    qDebug() << "\nTest 1: outline3D type";
    testImportSvgNodeData(test1);

    // 测试 2: 非 outline3D 类型的 SVGNODE
    QString test2 =
        "SVGNODE~{\"attrs\":{\"uuid\":\"6564f947c51b46459fed6fd8c26d021c\",\"title\":\"TestModel\",\"layerid\":20}}";
