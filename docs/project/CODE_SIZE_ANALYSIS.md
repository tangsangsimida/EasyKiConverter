...
当前基线：`src` 354 个文件、74,849 行；`tests` 58 个文件、18,581 行；翻译资源 2 个文件、3,303 行；`tools/python` 13 个文件、6,642 行。项目工具的 `--all` 统计覆盖产品源码、测试和翻译资源，工具目录单独统计后合计 427 个文件、103,375 行。
