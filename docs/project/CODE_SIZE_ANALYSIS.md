...
当前基线：`src` 357 个文件、74,865 行；`tests` 58 个文件、18,588 行；翻译资源 2 个文件、3,303 行；`tools/python` 13 个文件、6,642 行。项目工具的 `--all` 统计覆盖产品源码、测试和翻译资源，工具目录单独统计后合计 430 个文件、103,398 行。
