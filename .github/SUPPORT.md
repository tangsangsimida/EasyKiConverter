...
如果您在使用 EasyKiConverter 时遇到问题，这里有几种获取帮助的方式。

## 文档

首先，请查看我们的文档，大多数常见问题都可以在文档中找到答案：
...
1. **先搜索**：确保您的问题没有被讨论过
2. **提供详细信息**：包含操作系统、软件版本、错误日志等
3. **使用模板**：使用提供的 Issue 模板
4. **保持礼貌**：尊重所有社区成员
5. **分享解决方案**：如果您解决了问题，请分享解决方案

## 感谢

感谢您使用 EasyKiConverter！我们期待您的反馈和贡献。
