...
#ifdef _WIN32
/** @brief 在 Windows 调试控制台中重新打开标准输入输出流。 */
...
/** @brief 规范化 AppImage 挂载目录或开发构建目录的路径层级。 */
...
/** @brief 根据 AppImage 环境变量或应用路径解析运行时目录。 */
...
int main(int argc, char* argv[]) {
    ...
    QTimer::singleShot(0, []() {
        ...
        /** @brief 将 Qt 图形 API 枚举转换为日志中的可读名称。 */
