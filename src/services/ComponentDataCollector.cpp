...
namespace EasyKiConverter
{
    ...
    ComponentDataCollector::ComponentDataCollector(const QString &componentId, QObject *parent)
        : QObject(parent), m_componentId(componentId), m_state(Idle), m_export3DModel(true), m_isCancelled(false), m_api(new EasyedaApi(this)), m_importer(new EasyedaImporter(this))
    {
