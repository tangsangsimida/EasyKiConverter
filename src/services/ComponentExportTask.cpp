...
namespace EasyKiConverter
{
    ...
    ComponentExportTask::ComponentExportTask(const ComponentData &componentData,
                                             ...
                                             QObject *parent)
        : QObject(parent), QRunnable(), m_componentData(componentData), m_options(options), m_symbolExporter(symbolExporter), m_footprintExporter(footprintExporter), m_modelExporter(modelExporter)
    {
        setAutoDelete(true);
    }
