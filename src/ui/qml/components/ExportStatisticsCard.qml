...
Card {
    ...
    visible: exportStatisticsCard.exportProgressController
             ? exportStatisticsCard.exportProgressController.hasCompletedExport
             : false
    ColumnLayout {
        width: parent.width
        ...
        RowLayout {
            ...
            ModernButton {
                ...
                hoverColor: AppStyle.colors.border
                pressedColor: AppStyle.colors.borderFocus
                visible: exportStatisticsCard.exportSettingsController
                         ? exportStatisticsCard.exportSettingsController.debugMode
                         : false
                onClicked: {
                    if (exportStatisticsCard.exportProgressController) {
