...
/**
 * @brief 封装导出器通用接口
 * @details 定义将中间模型数据导出为目标 EDA 封装库格式的通用接口。
...
public:
     ...
     * @return 是否成功
     */
    virtual bool exportFootprint(const FootprintData& footprintData,
     ...
     * @return 是否成功
     */
    virtual bool exportFootprintLibrary(const QList<FootprintData>& footprints,
